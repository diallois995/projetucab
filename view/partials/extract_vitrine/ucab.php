<!-- ======= les Ucab Section ======= -->
<section id="services" class="services section-bg" style=" font-family: 'Merriweather',serif;">
      <div class="container" data-aos="fade-up">

        <div class="section-title">
          <h2 style="font-family: 'Merriweather',serif;">NOS UNIVERSITES</h2>
          <p>L’UCAB a clairement défini sa vision, sa mission, ses valeurs, qui sont celles
               religieuses de la confrérie Mouride du Sénégal fondées sur le travail rédempteur, <br>
               la paix, la tolérance, la quête du savoir et ses objectifs en matière de formation. <br>
               Elle s’est clairement fixée comme objectif la formation professionnelle des bacheliers arabes et l’intégration
                des structures 
              de formation traditionnelle dans le système officiel de l’éducation nationale.<br> Ce qui en fait sa spécificité.</p>
        </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
           <marquee><h3  style="font-family: 'Merriweather',serif; color:#fff;"> L’UNIVERSITE CHEIKH AHMADOUBAMBA (UCAB).</h3></marquee>
